...
PERMISSION_DEFINITIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("evolucoes:gerenciar", "Gerenciar evoluções", "Permite registrar e atualizar evoluções e notas de atendimento."),
    ("diagnosticos:ler", "Ler diagnósticos", "Permite consultar diagnósticos e problemas clínicos."),
    ("diagnosticos:gerenciar", "Gerenciar diagnósticos", "Permite registrar e atualizar diagnósticos e problemas clínicos."),
    ("sinais_vitais:ler", "Ler sinais vitais", "Permite consultar sinais vitais e registros de triagem."),
    ("sinais_vitais:gerenciar", "Gerenciar sinais vitais", "Permite registrar e atualizar sinais vitais e registros de triagem."),
    ("alergias:ler", "Ler alergias", "Permite consultar alergias, intolerâncias e reações adversas."),
    ("alergias:gerenciar", "Gerenciar alergias", "Permite registrar e atualizar alergias, intolerâncias e reações adversas."),
