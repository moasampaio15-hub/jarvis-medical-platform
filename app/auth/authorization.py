...
ROLE_PERMISSION_CODES: dict[str, tuple[str, ...]] = {
    ...
    "medico": ("medico", "perfil:ler", "pacientes:ler", "consultas:ler", "consultas:gerenciar", "prontuarios:ler", "prontuarios:escrever", "exames:ler", "medicamentos:ler"),
    "enfermeiro": ("enfermeiro", "perfil:ler", "pacientes:ler", "consultas:ler", "prontuarios:ler", "prontuarios:escrever", "medicamentos:ler"),
    "recepcionista": ("recepcionista", "perfil:ler", "pacientes:ler", "pacientes:criar", "pacientes:atualizar", "consultas:ler", "consultas:gerenciar"),
    "laboratorio": ("laboratorio", "perfil:ler", "pacientes:ler", "exames:ler", "exames:gerenciar"),
    "farmacia": ("farmacia", "perfil:ler", "pacientes:ler", "medicamentos:ler", "medicamentos:dispensar"),
